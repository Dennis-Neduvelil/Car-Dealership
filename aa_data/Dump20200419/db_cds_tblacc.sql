...
CREATE TABLE `tblacc` (
  ...
  `ac_brand` varchar(45) DEFAULT NULL,
  `ac_type` varchar(45) DEFAULT NULL,
  `ac_price` varchar(45) DEFAULT NULL,
  `ac_link` varchar(500) DEFAULT NULL,
  `ac_warrenty` varchar(100) DEFAULT NULL,
  `ac_img1` varchar(500) DEFAULT NULL,
  `ac_img2` varchar(500) DEFAULT NULL,
  `ac_img3` varchar(500) DEFAULT NULL,
  `ac_desc` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`ac_id`)
...
-- Dump completed on 2020-04-19 10:52:13
