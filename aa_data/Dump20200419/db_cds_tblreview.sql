...
CREATE TABLE `tblreview` (
  ...
  `rw_name` varchar(45) DEFAULT NULL,
  `rw_email` varchar(45) DEFAULT NULL,
  `rw_rev` varchar(300) DEFAULT NULL,
  `rw_stars` varchar(45) DEFAULT NULL,
...
INSERT INTO `tblreview` VALUES (23,1,'dennis','dnz@gmail.com','good ride','5','2020-04-19 00:00:00');
...
-- Dump completed on 2020-04-19 10:51:51
