...
CREATE TABLE `tblpayment` (
  ...
  `bd_id` varchar(45) DEFAULT NULL,
  `vr_id` int(11) DEFAULT NULL,
  `pd_card` varchar(45) DEFAULT NULL,
  `pd_card_no` varchar(45) DEFAULT NULL,
  `pd_cvv` varchar(45) DEFAULT NULL,
  `pd_exp` varchar(45) DEFAULT NULL,
  `pd_date` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`pd_id`)
...
-- Dump completed on 2020-04-19 10:52:08
