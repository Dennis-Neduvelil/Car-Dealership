<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="EmpRegReport.aspx.cs" Inherits="Admin_EmpRegReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-11" id="formContainer">
                    <div role="form" style="margin: 0 auto;">
                        <h1 class="page-header">Employee Registration Report</h1>
            ...
            <asp:GridView ID="grid_empreg" runat="server" CssClass="table-condensed" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Width="1010px" BorderStyle="None" BorderWidth="1px">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="e_join" HeaderText="Join Date" DataFormatString="{0:dd/MM/yyyy}"/>
