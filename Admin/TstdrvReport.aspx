<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="TstdrvReport.aspx.cs" Inherits="Admin_TstdrvReport" %>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12" id="formContainer">
                    <div role="form" style="margin: 0 auto;">
                        <h1 class="page-header">Test-Drive Report</h1>
                        ...
                        <asp:GridView ID="grid_tstdrv" runat="server" CssClass="table-condensed" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Width="1100px" BorderStyle="None" BorderWidth="1px" OnRowDataBound="grid_tstdrv_RowDataBound">
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                <asp:BoundField DataField="c_email" HeaderText="User Name" />
                <asp:BoundField DataField="tst_fname" HeaderText="Name" />
                <asp:BoundField DataField="tst_lname" />
                <asp:BoundField DataField="cn_dispname" HeaderText="Car" />
                <asp:BoundField DataField="vr_name" HeaderText="Version" />
                <asp:BoundField DataField="dl_name" HeaderText="Dealer" />
                <asp:BoundField DataField="pl_location" HeaderText="Place" />
                <asp:BoundField DataField="tst_mobile" HeaderText="Mobile" />
                <asp:BoundField DataField="tst_email" HeaderText="Email" />
                <asp:BoundField DataField="tst_book_date" HeaderText="Book Date" DataFormatString="{0:dd/MM/yyyy}"/>
                <asp:BoundField DataField="tst_test_date" HeaderText="Alloted Date" DataFormatString="{0:dd/MM/yyyy}"/>
            
                 <asp:TemplateField HeaderText="Devlivary">
