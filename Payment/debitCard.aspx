...
<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ForeColor="Red" ControlToValidate="txt_debit_card" ValidationExpression="[0-9]{16}" ValidationGroup="save" Text="Invalid Card number" />
                ...
                <asp:TextBox ID="txt_debit_card" runat="server" class="text-debit-card" onkeypress="return isNumberKey(event)" MaxLength="16" TextMode="Number"></asp:TextBox>
            </div>
        ...
        <div class="payment-debit-card-info">
           ...
           Text="Invalid CVV" />
                    <asp:TextBox ID="txt_cvv" runat="server" class="text-debit-card-cvv" onkeypress="return isNumberKey(event)" MaxLength="3" TextMode="Number"></asp:TextBox>
                </div>
            </div>
        </div>
